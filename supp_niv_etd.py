...
# Form implementation generated from reading ui file 'C:\Users\Mazen Sghaier\Documents\Python\project_2\supp_niv.ui'
#
...
"}")
        ...
        self.label.setGeometry(QtCore.QRect(220, 90, 211, 41))
        self.label.setStyleSheet("color: rgb(255, 255, 0);")
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")
        self.comboBox = QtWidgets.QComboBox(Dialog)
        self.comboBox.setGeometry(QtCore.QRect(260, 200, 131, 22))
        self.comboBox.setStyleSheet("color: rgb(255, 255, 0);")
    ...
    def OK(self):
        if self.comboBox.currentText()=="Choisir.." :
            self.k=0
            self.showDialog("Veuillez choisir une niveau!")
        else :
             if self.isimm.recherche_niveau(self.comboBox.currentText())==-1:
                self.showDialog("niveau n'existe pas!")
             else :  
                self.isimm.suppNiv(self.comboBox.currentText())
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "SUPPRIMER PAR NIVEAU"))
