...
# Form implementation generated from reading ui file 'C:\Users\Mazen Sghaier\Documents\Python\project_2\supp_sec_niv.ui'
#
...
"}")
        ...
        self.label.setGeometry(QtCore.QRect(240, 90, 221, 41))
        self.label.setStyleSheet("color: rgb(255, 255, 0);")
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")
        self.comboBox = QtWidgets.QComboBox(Dialog)
        self.comboBox.setGeometry(QtCore.QRect(230, 180, 261, 22))
...
"}")
        ...
        self.pushButton.setGeometry(QtCore.QRect(310, 310, 91, 31))
        self.pushButton.setStyleSheet("color: rgb(255, 255, 0);")
        self.pushButton.setObjectName("pushButton")
        self.comboBox_2 = QtWidgets.QComboBox(Dialog)
        self.comboBox_2.setGeometry(QtCore.QRect(230, 220, 131, 22))
        self.comboBox_2.setStyleSheet("color: rgb(255, 255, 0);")
    ...
    def OK(self):
        if self.comboBox.currentText()=="Choisir.." or self.comboBox_2.currentText()=="Choisir.." :
            self.k=0
            self.showDialog("Veuillez choisir une section et un niveau!")
        else :
             if self.isimm.recherche_sec_niv(self.comboBox.currentText(),self.comboBox_2.currentText())==-1:
                self.showDialog("niveau n'existe pas!")
             else :  
                self.isimm.suppSec_Niv(self.comboBox.currentText(),self.comboBox_2.currentText())
                self.showSuccess("Supprimer à effectué ")
        

    def retranslateUi(self, Dialog):
        _translate = QtCore.QCoreApplication.translate
        Dialog.setWindowTitle(_translate("Dialog", "Dialog"))
        self.label.setText(_translate("Dialog", "SUPPRIMER PAR SECTION ET NIVEAU"))
