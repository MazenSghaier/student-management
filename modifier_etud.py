...
# Form implementation generated from reading ui file 'C:\Users\Mazen Sghaier\Documents\Python\project\modifier.ui'
#
...
"}")
        ...
        self.label.setGeometry(QtCore.QRect(240, 90, 271, 20))
        font = QtGui.QFont()
...
"}")
        ...
        self.lineEdit_2.setGeometry(QtCore.QRect(170, 150, 191, 22))
...
"border-radius:15px;")
        ...
        self.pushButton.setGeometry(QtCore.QRect(340, 330, 75, 24))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(192, 192, 192))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
...
"")
        ...
        self.lineEdit_3.setGeometry(QtCore.QRect(310, 240, 191, 22))
        self.lineEdit_3.setStyleSheet("backgorund-color:rgba(0,0,0,0);\n"
"border:non;\n"
"border-bottom:2px solid rgba(105,118,132,255);\n"
"color: rgb(0, 85, 255);\n"
"padding-bottom:7px;")
        ...
        self.radioButton.setGeometry(QtCore.QRect(170, 240, 91, 21))
        palette = QtGui.QPalette()
        ...
        self.radioButton_2.setGeometry(QtCore.QRect(170, 200, 101, 21))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 85, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.radioButton_3.setGeometry(QtCore.QRect(170, 280, 89, 20))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 85, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.radioButton_3.setStyleSheet("color: rgb(0, 85, 255);")
    ...
    def OK(self):
        if not(len(self.lineEdit_2.text())==8) or not(self.lineEdit_2.text().isdigit()) :
            self.showDialog("Numéro d'inscription invalide! Il doit contient uniquement 8 chiffre")
        else :
            if self.isimm.recherche_ins(self.lineEdit_2.text())!=-1:
                k=self.isimm.recherche_ins(self.lineEdit_2.text())
                ...
                if self.radioButton_2.isChecked():        
                    if len(t)==0 or(t[0]!="9" and t[0]!="2" and t[0]!="4" and t[0]!="5" and len(t)!=8 and not(t.isdigit())):
                        ...
                        self.isimm.liste_etudiant[k].telephone=t
                    ...
                    if not(re.search(regex,t)):
                        ...
                        self.isimm.liste_etudiant[k].mail=t
                        self.showSuccess("La modification a effectué ")
                
                elif self.radioButton_3.isChecked():       
                    self.isimm.liste_etudiant[k].adresse=t
                    self.showSuccess("La modification a effectué ")
                else :
                    self.showDialog("Choix invalid!")
            else :
                self.showDialog("L'étudiant n'existe pas!")
    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
        self.label.setText(_translate("MainWindow", "   MENU MODIFIER ETUDIANT"))
        self.lineEdit_2.setPlaceholderText(_translate("MainWindow", "Numéro d\'inscription"))
        self.pushButton.setText(_translate("MainWindow", "OK"))
        self.radioButton.setText(_translate("MainWindow", "Mail"))
        self.radioButton_2.setText(_translate("MainWindow", "Téléphone"))
        self.radioButton_3.setText(_translate("MainWindow", "Adresse"))
