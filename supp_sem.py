...
# Form implementation generated from reading ui file 'C:\Users\Mazen Sghaier\Documents\Python\project_2\supp_sem.ui'
#
...
"}")
        ...
        self.comboBox_2.setGeometry(QtCore.QRect(240, 227, 151, 22))
...
"}")
        ...
        self.pushButton.setGeometry(QtCore.QRect(280, 290, 81, 31))
        self.pushButton.setStyleSheet("color: rgb(255, 255, 0);")
        self.pushButton.setObjectName("pushButton")
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(210, 120, 201, 41))
    ...
    def OK(self):
        if self.comboBox_2.currentText()=="Choisir.." :
            self.showDialog("Veuillez choisir la semestre!")
             ...
             if self.isimm.recherche_sem(self.comboBox_2.currentText())==-1:
                self.showDialog("Semestre n'existe pas!")
             else :  
                self.isimm.suppSem(self.comboBox_2.currentText())
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBox_2.setItemText(1, _translate("Dialog", "SEMESTRE 1"))
        self.comboBox_2.setItemText(2, _translate("Dialog", "SEMESTRE 2"))
        self.pushButton.setText(_translate("Dialog", "Supprimer"))
        self.label.setText(_translate("Dialog", "SUPPRIMER PAR SEMESTRE"))
