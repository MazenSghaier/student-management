...
# Form implementation generated from reading ui file 'C:\Users\Mazen Sghaier\Documents\Python\project_2\sup_etd_ins.ui'
#
...
"}")
        ...
        self.pushButton.setGeometry(QtCore.QRect(290, 270, 91, 31))
        self.pushButton.setStyleSheet("color: rgb(255, 255, 0);")
        self.pushButton.setObjectName("pushButton")
        self.lineEdit = QtWidgets.QLineEdit(Dialog)
        self.lineEdit.setGeometry(QtCore.QRect(240, 200, 201, 22))
        self.lineEdit.setStyleSheet("color: rgb(255, 255, 0);")
        self.lineEdit.setObjectName("lineEdit")
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(240, 80, 211, 51))
        ...
        if not(len(self.lineEdit.text())==8) or not(self.lineEdit.text().isdigit()) :
            ...
            self.showDialog("Numéro d'inscription invalide! Il doit contient uniquement 8 chiffre")
             ...
             if self.isimm.recherche_ins(self.lineEdit.text())==-1:
                ...
                self.isimm.suppIns(self.lineEdit.text())
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lineEdit.setPlaceholderText(_translate("Dialog", "Numéro d\'inscription"))
        self.label.setText(_translate("Dialog", "Supprimer étudiant "))
