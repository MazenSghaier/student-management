...
# Form implementation generated from reading ui file 'C:\Users\Mazen Sghaier\Documents\Python\project_2\manage_score.ui'
#
...
from test3 import ajoute as ins
from modifier_sco import modifier
import re
...
class note(object):
    def __init__(self,ISIMM):
        self.isimm= ISIMM
    def open_ajout_note(self):
        self.ajoute=ins(self.isimm)
    def open_modifier_note(self):
...
"}")
        self.pushButton = QtWidgets.QPushButton(Dialog,clicked = lambda:self.open_ajout_note())#modification 
        self.pushButton.setGeometry(QtCore.QRect(260, 150, 191, 61))
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtWidgets.QPushButton(Dialog,clicked = lambda:self.open_modifier_note())#modification 
        ...
        self.label.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(0, 65, 195, 255), stop:1 rgba(0, 0, 0, 255));")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Score manager"))
