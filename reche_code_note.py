...
# Form implementation generated from reading ui file 'C:\Users\Mazen Sghaier\Documents\Python\project_2\reche_code - note.ui'
#
    ...
    def OK(self):
        if not(len(self.lineEdit.text())==4) or not(self.lineEdit.text().isdigit()) :
            ...
            self.showDialog("Code invalide! Il doit contient uniquement 4 chiffre")
             ...
             if self.isimm.recherche_code_n(self.lineEdit.text())==-1:
                self.showDialog("Code de matiére n'existe pas!")
             else :  
                etudiant=self.isimm.liste_notes[self.isimm.recherche_code_n(self.lineEdit.text())]
                etu=[]
