...
# Form implementation generated from reading ui file 'C:\Users\Mazen Sghaier\Documents\Python\project_2\supp_nom.ui'
#
...
"}")
        ...
        self.label.setGeometry(QtCore.QRect(230, 110, 201, 41))
        self.label.setStyleSheet("color: rgb(255, 255, 0);")
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")
        self.pushButton = QtWidgets.QPushButton(Dialog)
        self.pushButton.setGeometry(QtCore.QRect(290, 310, 91, 41))
        self.pushButton.setStyleSheet("color: rgb(255, 255, 0);")
        self.pushButton.setObjectName("pushButton")
        self.lineEdit = QtWidgets.QLineEdit(Dialog)
        self.lineEdit.setGeometry(QtCore.QRect(250, 230, 181, 22))
    ...
    def OK(self):
        if len(self.lineEdit.text())==0 or not(self.lineEdit.text().isalpha()) :
            self.k=0
            self.showDialog("Nom invalide!")
        else :
             if self.isimm.recherche_des(self.lineEdit.text())==-1:
                self.showDialog("Nom n'existe pas!")
             else :  
                self.isimm.suppNom(self.lineEdit.text())
                self.showSuccess("Supprimer à effectué ")

    def retranslateUi(self, Dialog):
        _translate = QtCore.QCoreApplication.translate
        Dialog.setWindowTitle(_translate("Dialog", "Dialog"))
        self.label.setText(_translate("Dialog", "SUPPRIMER PAR NOM"))
        self.pushButton.setText(_translate("Dialog", "Supprimer"))
        self.lineEdit.setPlaceholderText(_translate("Dialog", "Donner le nom matiére"))
