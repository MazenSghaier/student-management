...
# Form implementation generated from reading ui file 'C:\Users\Mazen Sghaier\Documents\Python\project_2\reche_sec_niv.ui'
#
...
class recherche_sec_niv(object):
    def __init__(self,ISIMM):
        self.isimm=ISIMM
        self.alternative=[]
    def setupUi(self, Dialog):
        Dialog.setObjectName("Dialog")
        Dialog.resize(772, 430)
...
"}")
        ...
        self.pushButton.setGeometry(QtCore.QRect(380, 140, 75, 24))
        self.pushButton.setStyleSheet("color: rgb(85, 255, 255);")
        self.pushButton.setObjectName("pushButton")
        self.tableView = QtWidgets.QTableView(Dialog)
        self.tableView.setGeometry(QtCore.QRect(-20, 170, 791, 261))
        self.tableView.setStyleSheet("")
        self.tableView.setObjectName("tableView")
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(310, 10, 261, 21))
        self.label.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(85, 255, 255, 255), stop:1 rgba(0, 0, 0, 255));")
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")
        self.comboBox_2 = QtWidgets.QComboBox(Dialog)
        self.comboBox_2.setGeometry(QtCore.QRect(190, 110, 131, 22))
        ...
        self.label_2.setGeometry(QtCore.QRect(130, 60, 61, 20))
        ...
        self.label_3.setGeometry(QtCore.QRect(130, 110, 51, 20))
        self.label_3.setStyleSheet("color: rgb(85, 255, 255);")
        self.label_3.setObjectName("label_3")
        self.comboBox = QtWidgets.QComboBox(Dialog)
        self.comboBox.setGeometry(QtCore.QRect(190, 60, 261, 22))
    ...
    def OK(self):
            etudiants=self.isimm.recherche_sec_niv(self.comboBox.currentText(),self.comboBox_2.currentText())
            if etudiants!=-1 :
                for etudiant in etudiants:
                    ...
                    self.alternative.append(etu)


            self.modal=TableModel(self.alternative)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "RECHERCHE PAR SECTION ET NIVEAU"))
