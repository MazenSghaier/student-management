...
# Form implementation generated from reading ui file 'C:\Users\Mazen Sghaier\Documents\Python\project_2\reche_code.ui'
#
...
class TableModel(QtCore.QAbstractTableModel):
    def __init__(self, data):
        ...
        self._data = data
        self.columns=["Code","Désignation","Section","Coefficient","Semestre"]
...
"}")
        ...
        self.label_2.setGeometry(QtCore.QRect(240, 80, 51, 21))
        self.label_2.setObjectName("label_2")
        self.pushButton = QtWidgets.QPushButton(Dialog)
        self.pushButton.setGeometry(QtCore.QRect(320, 120, 75, 24))
        self.pushButton.setObjectName("pushButton")
        self.tableView = QtWidgets.QTableView(Dialog)
        self.tableView.setGeometry(QtCore.QRect(0, 160, 711, 261))
        self.tableView.setObjectName("tableView")
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(250, 10, 211, 31))
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")
        self.lineEdit = QtWidgets.QLineEdit(Dialog)
        self.lineEdit.setGeometry(QtCore.QRect(290, 80, 141, 22))
        ...
        if not(len(self.lineEdit.text())==4) or not(self.lineEdit.text().isdigit()) :
            ...
            self.showDialog("Code invalide! Il doit contient uniquement 4 chiffre")
             ...
             if self.isimm.recherche_code(self.lineEdit.text())==-1:
                self.showDialog("Code de matiére n'existe pas!")
             else :  
                etudiant=self.isimm.liste_matiere[self.isimm.recherche_code(self.lineEdit.text())]
                etu=[]
                etu.append(etudiant.code)
                etu.append(etudiant.designation)
                etu.append(etudiant.section)
                etu.append(etudiant.coeff)
                etu.append(etudiant.semestre)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "RECHERHCE PAR CODE MATIERE"))
