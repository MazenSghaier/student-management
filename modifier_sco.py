...
# Form implementation generated from reading ui file 'C:\Users\Mazen Sghaier\Documents\Python\project_2\modifier_sco.ui'
#
...
"}")
        ...
        self.pushButton.setGeometry(QtCore.QRect(340, 340, 75, 24))
        self.pushButton.setObjectName("pushButton")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(290, 60, 201, 31))
        self.label.setStyleSheet("color: rgb(255, 170, 0);")
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")
        self.radioButton = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButton.setGeometry(QtCore.QRect(200, 230, 89, 20))
        self.radioButton.setStyleSheet("color: rgb(255, 170, 0);")
        self.radioButton.setObjectName("radioButton")
        self.radioButton_2 = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButton_2.setGeometry(QtCore.QRect(200, 270, 89, 20))
        self.radioButton_2.setStyleSheet("color: rgb(255, 170, 0);")
        self.radioButton_2.setObjectName("radioButton_2")
        self.lineEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit.setGeometry(QtCore.QRect(200, 170, 161, 22))
        self.lineEdit.setStyleSheet("color: rgb(255, 170, 0);")
        self.lineEdit.setObjectName("lineEdit")
        self.lineEdit_2 = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_2.setGeometry(QtCore.QRect(310, 250, 151, 22))
        self.lineEdit_2.setStyleSheet("color: rgb(255, 170, 0);")
    ...
    def OK(self):
        if not(len(self.lineEdit.text())==8) or not(self.lineEdit.text().isdigit()) :
            ...
            if self.isimm.recherche_ins(self.lineEdit.text())!=-1:
                x=0.25
                k=self.isimm.recherche_ins(self.lineEdit.text()) 
                t=self.lineEdit_2.text()
                if self.radioButton.isChecked():        
                    if len(t)==0 or not(t.isdigit()):
                        self.showDialog("Note ds invalide!")
                    else :
                        self.isimm.liste_notes[k].ds=t
                        self.showSuccess("La modification a effectué ")
                elif self.radioButton_2.isChecked():
                    if len(t)==0 or not(t.isdigit()):
                        self.showDialog("Note examen invalide!")
                    else :
                        self.isimm.liste_notes[k].ex=t
                        self.showSuccess("La modification a effectué ")
            else :
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "MODIFIER NOTES"))
        self.radioButton.setText(_translate("MainWindow", "Note DS"))
        self.radioButton_2.setText(_translate("MainWindow", "Note Ex"))
        self.lineEdit.setPlaceholderText(_translate("MainWindow", "Numéro d\'inscription"))
