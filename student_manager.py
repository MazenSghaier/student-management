...
# Form implementation generated from reading ui file 'C:\Users\Mazen Sghaier\Documents\Python\project_2\manage_student.ui'
#
...
from test import Ajoute as ins
from modifier import modifier
from supp_etd import sup_etd
import re
...
class Ui_Dialog(object):
    def __init__(self,ISIMM):
        self.isimm= ISIMM
    def open_ajout_etudiant(self):
        self.ajoute=ins(self.isimm)
    def open_modifier_etudiant(self):
        self.window=QtWidgets.QMainWindow()
        self.affiche=modifier(self.isimm)
        self.affiche.setupUi(self.window)
        self.window.show()
    def open_supprimer_etudiant(self):
        self.window=QtWidgets.QMainWindow()
        self.affiche=sup_etd(self.isimm)
        self.affiche.setupUi(self.window)
        self.window.show()
    def setupUi(self, Dialog):
        Dialog.setObjectName("Dialog")
        Dialog.resize(735, 526)
...
"}")
        ...
        self.pushButton = QtWidgets.QPushButton(Dialog,clicked = lambda:self.open_ajout_etudiant())#modification 
        self.pushButton.setGeometry(QtCore.QRect(260, 150, 191, 61))
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtWidgets.QPushButton(Dialog,clicked = lambda:self.open_modifier_etudiant())#modification 
        self.pushButton_2.setGeometry(QtCore.QRect(260, 240, 191, 61))
        self.pushButton_2.setObjectName("pushButton_2")
        self.pushButton_3 = QtWidgets.QPushButton(Dialog,clicked = lambda:self.open_supprimer_etudiant())#modification 
        self.pushButton_3.setGeometry(QtCore.QRect(260, 330, 191, 61))
        self.pushButton_3.setObjectName("pushButton_3")
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(230, 60, 251, 41))
        self.label.setStyleSheet("background-color:qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(79, 0, 0, 255), stop:1 rgba(0, 0, 0, 255));")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Student manager"))
