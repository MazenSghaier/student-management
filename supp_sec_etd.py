...
# Form implementation generated from reading ui file 'C:\Users\Mazen Sghaier\Documents\Python\project_2\supp_sec.ui'
#
...
"}")
        ...
        self.label.setGeometry(QtCore.QRect(200, 60, 191, 41))
        self.label.setStyleSheet("color: rgb(255, 255, 0);")
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")
        self.comboBox = QtWidgets.QComboBox(Dialog)
        self.comboBox.setGeometry(QtCore.QRect(170, 180, 261, 22))
...
"}")
    ...
    def OK(self):
        if self.comboBox.currentText()=="Choisir.." :
            ...
            self.showDialog("Veuillez choisir une section!")
             ...
             if self.isimm.recherche_section(self.comboBox.currentText())==-1:
                self.showDialog("section n'existe pas!")
             else :  
                self.isimm.suppSec(self.comboBox.currentText())
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "SUPPRIMER PAR SECTION"))
