...
# Form implementation generated from reading ui file 'C:\Users\Mazen Sghaier\Documents\Python\project_2\supp_etd.ui'
#
...
import re
from sup_etd_ins import supp_ins
from supp_sec_etd import supp_sec
from supp_niv_etd import supp_niv
from supp_sec_niv import supp_sec_niv
...
class sup_etd(object):
    def __init__(self,ISIMM):
        self.isimm= ISIMM
    def open_supp_ins(self):
        self.window=QtWidgets.QDialog()
        self.affiche=supp_ins(self.isimm)
        self.affiche.setupUi(self.window)
        self.window.show()
    def open_supp_sec(self):
        self.window=QtWidgets.QDialog()
        self.affiche=supp_sec(self.isimm)
        self.affiche.setupUi(self.window)
        self.window.show()
    def open_supp_niv(self):
        self.window=QtWidgets.QDialog()
        self.affiche=supp_niv(self.isimm)
        self.affiche.setupUi(self.window)
        self.window.show()
    def open_supp_sec_niv(self):
        self.window=QtWidgets.QDialog()
        self.affiche=supp_sec_niv(self.isimm)
        self.affiche.setupUi(self.window)
        self.window.show()
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("MainWindow")
        MainWindow.resize(786, 574)
...
"}")
        ...
        self.label.setGeometry(QtCore.QRect(300, 70, 191, 51))
        self.label.setStyleSheet("color: rgb(0, 188, 0);")
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget,clicked = lambda:self.open_supp_ins())#modification 
        self.pushButton.setGeometry(QtCore.QRect(300, 180, 191, 41))
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtWidgets.QPushButton(self.centralwidget,clicked = lambda:self.open_supp_sec())#modification 
        self.pushButton_2.setGeometry(QtCore.QRect(300, 250, 191, 41))
        self.pushButton_2.setObjectName("pushButton_2")
        self.pushButton_3 = QtWidgets.QPushButton(self.centralwidget,clicked = lambda:self.open_supp_niv())#modification 
        self.pushButton_3.setGeometry(QtCore.QRect(300, 320, 191, 41))
        self.pushButton_3.setObjectName("pushButton_3")
        self.pushButton_4 = QtWidgets.QPushButton(self.centralwidget,clicked = lambda:self.open_supp_sec_niv())#modification 
        self.pushButton_4.setGeometry(QtCore.QRect(300, 390, 191, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "SUPPRIMER ETUDIANT"))
        self.pushButton.setText(_translate("MainWindow", "Suppression étudiant donnée"))
        self.pushButton_2.setText(_translate("MainWindow", "Suppression par section"))
        self.pushButton_3.setText(_translate("MainWindow", "Suppression par niveau"))
        self.pushButton_4.setText(_translate("MainWindow", "Suppression par section\n"
"et niveau"))
