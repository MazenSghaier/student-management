...
# Form implementation generated from reading ui file 'C:\Users\Mazen Sghaier\Documents\Python\project_2\Recherche_n_ins.ui'
#
        ...
        if not(len(self.lineEdit.text())==8) or not(self.lineEdit.text().isdigit()) :
            ...
            self.showDialog("Numéro d'inscription invalide! Il doit contient uniquement 8 chiffre")
             ...
             if self.isimm.recherche_ins(self.lineEdit.text())==-1:
                ...
                etudiant=self.isimm.liste_etudiant[self.isimm.recherche_ins(self.lineEdit.text())]
                etu=[]
