...
# Form implementation generated from reading ui file 'C:\Users\Mazen Sghaier\Documents\Python\project_2\rech_niv.ui'
#
...
class recherche_niv(object):
    def __init__(self,ISIMM):
        self.isimm=ISIMM
        self.alternative=[]
    def setupUi(self, Dialog):
        Dialog.setObjectName("Dialog")
        Dialog.resize(788, 422)
...
"}")
        ...
        self.label_3.setGeometry(QtCore.QRect(280, 70, 61, 20))
        self.label_3.setStyleSheet("color: rgb(85, 255, 255);")
        self.label_3.setObjectName("label_3")
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(280, 10, 241, 21))
        ...
        self.tableView.setGeometry(QtCore.QRect(0, 160, 791, 261))
        self.tableView.setStyleSheet("")
        self.tableView.setObjectName("tableView")
        self.comboBox = QtWidgets.QComboBox(Dialog)
        self.comboBox.setGeometry(QtCore.QRect(350, 70, 131, 22))
    ...
    def OK(self):
            etudiants=self.isimm.recherche_niveau(self.comboBox_2.currentText())
            if etudiants!=-1 :
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "RECHERCHE PAR NIVEAU"))
