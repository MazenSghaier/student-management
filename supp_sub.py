...
# Form implementation generated from reading ui file 'C:\Users\Mazen Sghaier\Documents\Python\project_2\supp_sub.ui'
#
...
import re
from supp_nom import supp_nom
from supp_sem import supp_sem
...
class sup_sub(object):
    def __init__(self,ISIMM):
        self.isimm= ISIMM
    def open_supp_nom(self):
        self.window=QtWidgets.QDialog()
        self.affiche=supp_nom(self.isimm)
        self.affiche.setupUi(self.window)
        self.window.show()
    def open_supp_sem(self):
        self.window=QtWidgets.QDialog()
        self.affiche=supp_sem(self.isimm)
        self.affiche.setupUi(self.window)
        self.window.show()
    def setupUi(self, Dialog):
        Dialog.setObjectName("Dialog")
        Dialog.resize(731, 551)
...
"}")
        self.pushButton = QtWidgets.QPushButton(Dialog,clicked = lambda:self.open_supp_nom())#modification
        self.pushButton.setGeometry(QtCore.QRect(300, 220, 151, 51))
        self.pushButton.setStyleSheet("color: rgb(0, 170, 0);")
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtWidgets.QPushButton(Dialog,clicked = lambda:self.open_supp_sem())#modification
        self.pushButton_2.setGeometry(QtCore.QRect(300, 320, 151, 51))
        self.pushButton_2.setStyleSheet("color: rgb(0, 170, 0);")
        self.pushButton_2.setObjectName("pushButton_2")
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(250, 110, 251, 51))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton.setText(_translate("Dialog", "Supprimer par nom"))
        self.pushButton_2.setText(_translate("Dialog", "Supprimer par semestre"))
        self.label.setText(_translate("Dialog", "SUPPRIMER MATIERES"))
