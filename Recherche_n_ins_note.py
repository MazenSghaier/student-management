...
# Form implementation generated from reading ui file 'C:\Users\Mazen Sghaier\Documents\Python\project_2\Recherche_n_ins - note.ui'
#
...
class TableModel(QtCore.QAbstractTableModel):
    def __init__(self, data):
        ...
        self._data = data
        self.columns=["Code","Numéro d'inscription","Note DS","Node Examen"]
...
"}")
        ...
        self.tableView.setGeometry(QtCore.QRect(-5, 170, 761, 231))
        self.tableView.setStyleSheet("")
        self.tableView.setObjectName("tableView")
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(250, 20, 291, 21))
        self.label.setStyleSheet("")
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")
        self.lineEdit = QtWidgets.QLineEdit(Dialog)
        self.lineEdit.setGeometry(QtCore.QRect(312, 90, 161, 22))
        self.lineEdit.setStyleSheet("")
        self.lineEdit.setText("")
        self.lineEdit.setObjectName("lineEdit")
        self.label_2 = QtWidgets.QLabel(Dialog)
        self.label_2.setGeometry(QtCore.QRect(170, 90, 141, 20))
        self.label_2.setStyleSheet("")
        self.label_2.setObjectName("label_2")
        self.pushButton = QtWidgets.QPushButton(Dialog)
        self.pushButton.setGeometry(QtCore.QRect(360, 140, 75, 24))
    ...
    def OK(self):
        if not(len(self.lineEdit.text())==8) or not(self.lineEdit.text().isdigit()) :
            ...
            self.showDialog("Numéro d'inscription invalide! Il doit contient uniquement 8 chiffre")
             ...
             if self.isimm.recherche_ins_n(self.lineEdit.text())==0:
                self.showDialog("Numéro d'inscription n'existe pas!")
             else :  
                etudiant=self.isimm.liste_notes[self.isimm.recherche_ins_n(self.lineEdit.text())]
                etu=[]
                etu.append(etudiant.code_matiére)
                etu.append(etudiant.nInscription)
                etu.append(etudiant.ds)
                etu.append(etudiant.ex)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "RECHERCHE PAR NUMERO D\'INSCRIPTION"))
        self.label_2.setText(_translate("Dialog", "Numero d\'inscription :"))
